...
export const projects = [
     ...
     },
     {
          ...
          bgColor: "bg-blue-700",
          description:
               "Strategic SEO optimization that increased organic traffic by 150% and improved search rankings.",
     },
     {
          id: "plainst-tech",
          title: "Plainst Tech",
          ...
          bgColor: "bg-lime-500",
          description:
               "A comprehensive digital marketing campaign that boosted brand awareness and customer engagement.",
     },
     {
          ...
          bgColor: "bg-sky-500",
          description:
               "Custom web development solutions that streamlined operations and enhanced customer experience.",
     },
     {
          id: "existernal-ltd",
          ...
          bgColor: "bg-lime-500",
          description:
               "Data analytics implementation that provided actionable insights and drove strategic decision-making.",
     },
     {
          id: "coderama",
          title: "Coderama",
          ...
          description:
               "Mobile app development that expanded the client's digital footprint and user engagement.",
     },
];
