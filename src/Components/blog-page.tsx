  ...
  return (
    <>
      <div className="max-w-5xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
        {selectedPost ? (
          <div>
            <button onClick={handleBackClick} className="mb-6 flex items-center text-blue-500 hover:text-blue-700">
      ...
      <div id="subscribe" className="bg-[#55b4e4] text-white py-8 px-4 mt-12">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center">
            <svg className="h-8 w-8 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          <div className="flex flex-col md:flex-row gap-4 flex-1 max-w-2xl">
            <input
              type="text"
              placeholder="Name"
              className="flex-1 px-4 py-2 rounded-md bg-transparent border border-white placeholder-white/80 focus:outline-none"
            />
            <input
              type="email"
              placeholder="Email"
