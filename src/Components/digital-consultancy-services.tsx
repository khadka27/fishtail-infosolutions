...
const consultancyFeatures = [
     {
          ...
          description:
               "Comprehensive digital strategies aligned with your business goals and market opportunities.",
          icon: Briefcase,
          color: "blue",
     },
     {
          ...
          description:
               "Continuous monitoring of your online reputation across all digital channels and platforms.",
          icon: Eye,
          color: "red",
     },
     {
          ...
          description:
               "Proactive and reactive strategies to address reputation threats and minimize negative impact.",
          icon: AlertTriangle,
          color: "orange",
     },
     {
          ...
          description:
               "In-depth analysis of your competitors' digital presence and strategies to identify opportunities.",
          icon: TrendingUp,
          color: "green",
     },
     {
          ...
          description:
               "Strategic management of customer reviews to highlight positive feedback and address concerns.",
          icon: Star,
          color: "purple",
     },
     {
          ...
          description:
               "Guidance on adopting digital technologies to improve efficiency and customer experience.",
          icon: PieChart,
          color: "teal",
     },
];
...
const consultancySteps = [
     {
          ...
          description:
               "We analyze your current digital presence, reputation, and identify areas for improvement.",
          icon: Search,
     },
     {
          title: "Strategy Development",
          description:
               "We create a customized strategy to enhance your digital presence and reputation.",
          icon: Briefcase,
     },
     {
          title: "Implementation",
          description:
               "Our team executes the strategy across all relevant digital channels and platforms.",
          icon: CheckCircle,
     },
     {
          title: "Monitoring & Management",
          description:
               "Continuous monitoring of your online reputation and implementation of management tactics.",
          icon: Eye,
     },
     {
          title: "Crisis Preparedness",
          description:
               "Development of crisis management protocols to quickly address potential reputation threats.",
          icon: Shield,
     },
     {
          title: "Reporting & Optimization",
          description:
               "Regular reporting on reputation metrics and ongoing optimization of strategies.",
          icon: FileText,
     },
];
...
const projects = [
     {
          ...
          description:
               "Reputation recovery strategy after product recall, resulting in restored consumer trust.",
          image: image2,
          bgColor: "bg-[#1ab5b3]",
     ...
     },
     {
          ...
          description:
               "Digital strategy to highlight patient success stories and address negative reviews.",
          image: image3,
          bgColor: "bg-[#2c3e50]",
     ...
     },
     {
          ...
          description:
               "Digital transformation strategy for traditional financial institution entering online banking.",
          image: image4,
          bgColor: "bg-[#8bc34a]",
     ...
     },
     {
          ...
          description:
               "Rapid response strategy to food safety concerns that preserved brand reputation.",
          image: image1,
          bgColor: "bg-[#e74c3c]",
     ...
     },
     {
          ...
          description:
               "Strategic positioning and reputation building for emerging technology company.",
          image: image2,
          bgColor: "bg-[#9b59b6]",
          ...
          <div className="flex flex-col" ref={sectionRef}>
               ...
               >
                    <div className="max-w-4xl mx-auto">
                         ...
                         >
                              Build, protect, and enhance your{" "}
                              <span className="font-bold">
                                   digital reputation
                              </span>{" "}
                              with strategic consulting that transforms
                              challenges into{" "}
                              <span className="font-bold">
               ...
               >
                    ...
                    >
                         ...
                         <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                              From strategic planning to crisis management, we
                              offer end-to-end digital consultancy and
                              reputation management services tailored to your
                              business needs.
                         </p>
                    </motion.div>
               ...
               >
                    <div className="max-w-6xl mx-auto">
                         ...
                         >
                              ...
                              <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                                   In today&apos;s digital world, your online
                                   reputation can make or break your business.
                                   Here&apos;s why proactive management is
                                   essential.
                              </p>
                         </motion.div>
                         ...
                         >
                              <motion.div
                                   ...
                                   whileHover={{ y: -5 }}
                              >
                                   <div className="text-4xl font-light text-[#2c3e50] mb-2">
                                        92%
                                   </div>
                                   <div className="text-sm text-gray-600">
                                        of consumers read online reviews before
                                        making a purchase
                                   </div>
                              </motion.div>
                              ...
                              >
                                   ...
                                   <div className="text-sm text-gray-600">
                                        more likely to buy when referred by a
                                        friend
                                   </div>
                              </motion.div>
                              ...
                              >
                                   ...
                                   <div className="text-sm text-gray-600">
                                        of consumers say negative reviews made
                                        them not use a business
                                   </div>
                              </motion.div>
                         </motion.div>
                    </div>
               ...
               >
                    ...
                    >
                         ...
                         <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                              We follow a structured approach to develop and
                              implement digital strategies that enhance your
               ...
               >
                    <div className="max-w-6xl mx-auto">
                         ...
                         >
                              ...
                              <Link
                                   href="/project"
                                   className="text-[#2c3e50] text-sm hover:underline flex items-center"
                              >
               ...
               <div ref={formRef} className="py-16 px-4">
                    ...
                    >
                         <div className="text-center mb-8">
                              <h2 className="text-3xl font-light text-gray-700 mb-4">
                                   Get Expert Digital Consultancy
                              </h2>
                              <p className="text-gray-600 max-w-2xl mx-auto">
                                   Tell us about your business challenges and
                                   goals, and we&apos;ll provide strategic
                                   guidance to enhance your digital presence and
                                   reputation.
                              </p>
                         </div>
                         <Form />
