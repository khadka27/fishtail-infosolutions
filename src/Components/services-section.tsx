     ...
     const serviceCards = [
          {
               ...
               features: ["PPC Campaigns", "Email Automation", "LinkedIn Ads"],
          ...
          },
          {
               ...
               features: ["Competitor Analysis", "On-Page SEO", "Blogging"],
          ...
          },
          {
               ...
               features: ["Funnel Tracking", "A/B Testing", "Heatmaps"],
     ...
     const additionalServices = [
          {
               ...
               icon: MapPin,
               color: "#0084FF",
               details: "We use agile methodologies to deliver pixel-perfect, SEO-friendly websites that align with your business objectives.",
          ...
          },
          {
               ...
               icon: Map,
               color: "#003C8F",
               details: "Our granular approach targets low-hanging keywords, fixes site issues, and builds domain authority.",
          ...
          },
          {
               ...
               icon: Link2,
               color: "#0084FF",
               details: "From LinkedIn outreach to cold email sequencing, we fill your pipeline with qualified prospects.",
          ...
          },
          {
               ...
               icon: Target,
               color: "#003C8F",
               details: "Our paid advertising team crafts high-converting campaigns that focus on targeting the right audience, optimizing ad spend, and maximizing ROI.",
          ...
          },
          {
               ...
               icon: PenTool,
               color: "#0084FF",
               details: "Our PPC experts structure campaigns to target buyer intent, reduce CPA, and amplify ROI.",
               redirect: "/Services/web-development",
          },
          {
               ...
               icon: Mail,
               color: "#003C8F",
               details: "We design mobile-responsive templates and A/B test subject lines to boost deliverability.",
     ...
     const serviceTabs = [
          {
               title: "For Startups",
               icon: Users,
               content: "Cost-effective web and SEO packages to establish your online presence and attract early adopters.",
               services: [
                    "Local SEO",
                    "Google Ads",
                    "Landing Pages",
          ...
          },
          {
               ...
               icon: BarChart,
               content: "SEO and PPC strategies to increase product visibility, cart size, and repeat purchases.",
               services: [
                    "Shopify SEO",
                    "Google Shopping",
          ...
          },
          {
               ...
               icon: TrendingUp,
               content: "Enterprise-grade web solutions, multi-channel SEO, and automation to streamline global operations.",
               services: [
                    "Scalable SEO",
               ...
               <div className="container mx-auto">
                    ...
                    >
                         ...
                         <p className="text-center text-gray-600 mb-8 sm:mb-12 lg:mb-16 max-w-3xl mx-auto">
                              From web development to lead capture, we merge
                              creativity and analytics to fuel sustainable
                              growth.
                         </p>
                    </div>
                                   ...
                                   <div className="p-6 flex flex-col items-center h-full relative z-10">
                                        ...
                                        >
                                             ...
                                             <div className="mt-4 flex justify-center">
                                                  <Link
                                                       href={service.link}
                                                       className="flex items-center text-white hover:text-white/80 transition-colors text-sm bg-white/20 px-3 py-1 rounded-full"
                                                  >
                                                       Learn more{" "}
                                             ...
                                             {activeService === index && (
                                                  <div className="mt-3 animate-fadeIn">
                                                       ...
                                                       <Link
                                                            ...
                                                            className="flex items-center text-[#0084FF] hover:text-[#003C8F] transition-colors text-sm"
                                                       >
                                                            Learn more{" "}
                                                            <ArrowRight className="ml-1 w-3 h-3" />
                                                       </Link>
                         ...
                         <div className="flex flex-col md:flex-row items-center">
                              ...
                              <div>
                                   ...
                                   <p className="text-[#003C8F] italic mb-2">
                                        ...
                                        transformed our online presence. We've
                                        seen a 200% increase in qualified leads
                                        and our conversion rates have never been
                                        better!"
                                   </p>
                                   <p className="text-gray-600 text-sm">
