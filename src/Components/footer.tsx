     ...
     useEffect(() => {
          const handleScroll = () => {
               ...
               if (newsletterRef.current) {
                    ...
                    if (isInView) {
                         newsletterRef.current.classList.add(
                              "animate-pulse-subtle"
                         );
                         setTimeout(() => {
                              if (newsletterRef.current) {
                                   newsletterRef.current.classList.remove(
                                        "animate-pulse-subtle"
                                   );
                              }
                         }, 1000);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                         ...
                         >
                              ...
                              <p className="text-white/80 mb-6">
                                   ...
                                   we help businesses increase their online
                                   visibility, drive targeted traffic, and
                                   achieve measurable growth in sales and
                                   conversions.
                              </p>
