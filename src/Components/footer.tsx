      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 mb-8 md:mb-16">
          ...
          <div>
            <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
              With our theme, you no longer need to depend on predesigned footer
              layouts. Now, you can easily create your own with our intuitive
              drag & drop builder. Choose any columns variation, content element
              or color theme!
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-16">
          ...
          <div className="flex items-center sm:col-span-2 md:col-span-1">
            ...
            <div>
              <div className="text-lg md:text-xl">request a free quote</div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-6 md:mt-8 text-gray-500 text-xs sm:text-sm">
          ©2024 SEO & WP Marketing Agency. All Rights Reserved. Part of Blue
          Astral family
        </div>
      </div>
    </footer>
