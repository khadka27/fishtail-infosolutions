...
export function Header() {
     ...
     // Add this useEffect to handle clicks outside the social media dropdown
     useEffect(() => {
     ...
     const phoneNumber = "+9779806673560"; // Formatted for WhatsApp
     ...
     return (
          <>
               <header
                    className={`relative z-50 ${scrolled ? "shadow-md" : ""}`}
               >
                    {/* Top bar */}
                ...
                Easy to use theme with exciting features
                              ...
                              <div className="flex items-center space-x-4 md:space-x-8">
                                   ...
                                   >
                                        ...
                                        >
                                             ...
                                             <span className="hidden md:inline text-sm md:text-base hover:underline">
                                                  follow us
                                             </span>
                                        </div>
                    ...
                    >
                         <div className="container mx-auto flex justify-between items-center">
                              ...
                              {/* Fishtail infosolutions 3006 port ma, */}
                              <div className="flex items-center">
                                   ...
                                   <div className="flex items-center space-x-2 md:space-x-4">
                                        ...
                                        >
                                             <Button className="bg-blue-600 hover:bg-blue-900 text-white px-4 md:px-8 py-2 md:py-3 h-auto text-xs md:text-sm lg:text-base rounded-md flex items-center">
                                                  <svg
