          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              >
                ...
                <span className="hidden md:inline text-sm md:text-base">info@fishtailinfosolutions.com</span>
              </Link>
              <div ref={socialMenuRef} className="relative flex items-center cursor-pointer">
                <div onClick={toggleSocialMenu} className="flex items-center">
                  <Share2 className="h-4 w-4 md:h-4 md:w-4 mr-0 md:mr-2" />
                  <span className="hidden md:inline text-sm md:text-base hover:underline">follow us</span>
                </div>
