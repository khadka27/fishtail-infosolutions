      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-blue-100 mb-4 text-sm">Get a response within 24 hours</p>
                <Link href="mailto:info@fishtailinfo.com" className="text-white font-medium hover:underline">
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-blue-100 mb-4 text-sm">Book a free 30-minute consultation</p>
                <Link
                  href="/contact"
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <p className="text-blue-100 mb-4 text-sm">Speak with an expert now</p>
                <Link href="tel:+919876543210" className="text-white font-medium hover:underline">
                  +91 98765 43210
                </Link>
              </div>
            </motion.div>
          ...
          >
            ...
            <p className="mt-4 text-sm text-blue-200">No obligation. Learn how we can help you grow.</p>
          </motion.div>
        </div>
      </div>
    </section>
