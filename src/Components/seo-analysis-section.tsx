...
const testimonials = [
     ...
     {
          id: 2,
          quote: "Their SEO analysis helped us increase our organic traffic by 45% in just three months. The insights were practical and easy to implement.",
          author: "Michael Chen",
     ...
     {
          id: 3,
          quote: "The team provided actionable recommendations that made an immediate impact on our search rankings. Highly recommended!",
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
                              <div>
                                   ...
                                   <p className="text-lg text-gray-700">
                                        Our team is ready to review your
                                        website&apos;s SEO aspects and provide
                                        some tips to help you increase traffic,
                                        drive leads and maximize revenue.
                                   </p>
                              </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                         ...
                         <div className="lg:col-span-2">
                              ...
                              <form onSubmit={handleSubmit}>
                                   ...
                                   <p className="text-sm text-gray-500 mb-6">
                                        Please, let us know any particular
                                        things to check and the best time to
                                        contact you by phone (if provided).
                                   </p>
                         ...
                         <div className="lg:col-span-1">
                              <div className="mb-4 flex items-center justify-between">
                                   <h3 className="text-2xl font-light text-green-600">
                                        Testimonials
                                   </h3>
                                   <Link
                                        href="/testimonials"
