  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-4xl font-bold mb-2 relative z-10">{price}</div>
        <div className="text-sm opacity-90 relative z-10">{description}</div>
        <motion.button
          ...
          >
            ...
            >
              <div className="flex items-center">
                <Check className={`h-4 w-4 text-${accentColor} mr-2`} />
                <span className="text-gray-700">{feature.name}</span>
              </div>
              <div className={`${accentBgColor} rounded-full p-1`}>
                {openFeatures[feature.name] ? (
                  <Minus className={`h-4 w-4 text-${accentColor}`} />
                ) : (
            ...
            <AnimatePresence>
              {openFeatures[feature.name] && feature.description && (
                <motion.div
