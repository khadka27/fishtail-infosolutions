     ...
     useEffect(() => {
          ...
          const loadMap = async () => {
               try {
                    ...
                    img.onerror = () => {
                         console.warn(
                              "Custom marker icon failed to load, using default"
                         );
        ...
        `;
                    ...
                    console.log(
                         "Opening popup for active location:",
                         activeLocation.name
                    );
                    const activeMarker = L.marker(activeLocation.coordinates, {
                         icon: customIcon,
                    })
                         .addTo(map)
                         .bindPopup(
                              `<strong>${activeLocation.name}</strong><br>${activeLocation.address}`
                         )
                         .openPopup();
