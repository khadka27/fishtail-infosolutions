        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-blue-100">
              See how our lead generation strategies have transformed businesses across industries
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "385% Increase in Qualified Leads",
                description:
                  "Implemented a content-driven lead generation strategy for a SaaS company, resulting in a 385% increase in qualified leads",
                stats: [
                  { label: "Lead Increase", value: "385%" },
                  { label: "Cost Per Lead", value: "-42%" },
                ],
              },
              {
                industry: "Professional Services",
                title: "2.8x Growth in Sales Pipeline",
                description:
                  "Developed a multi-channel lead generation program for a consulting firm that nearly tripled their sales pipeline",
                stats: [
                  { label: "Pipeline Growth", value: "2.8x" },
                  { label: "Conversion Rate", value: "24.3%" },
                ],
              },
              {
                industry: "Healthcare",
                title: "$2.4M in New Revenue",
                description:
                  "Created a targeted lead generation campaign for a healthcare provider, generating $2.4M in new revenue",
                stats: [
                  { label: "New Revenue", value: "$2.4M" },
                  { label: "ROI", value: "347%" },
                ],
              },
            ].map((study, index) => (
              ...
              >
                <div className="h-48 overflow-hidden">
                  <Image
                    src={`/abstract-lead-generation.png?height=300&width=500&query=lead generation for ${study.industry} business`}
                    alt={study.title}
                    width={500}
                    height={300}
                ...
                <div className="p-6">
                  <div className="text-cyan-300 text-sm font-medium mb-2">{study.industry}</div>
