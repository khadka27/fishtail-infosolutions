      ...
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white z-10 flex justify-between items-center p-4 border-b">
          <h2 className="text-2xl font-light text-gray-800">
            {submitStatus?.success ? "Order Confirmation" : "Order Digital Marketing Services"}
          </h2>
        ...
        <div className="p-6">
          {submitStatus?.success ? (
            <div className="text-center py-10">
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-2">Thank You for Your Order!</h3>
              <p className="text-lg text-gray-600 mb-6">
                Your order has been submitted successfully. We&apos;ll be in touch with you shortly.
              </p>
            ...
            <>
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 space-y-8">
                    ...
                    <div className="flex items-start mb-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          We love getting things right and want you to be fully satisfied with services provided. We are
                          not perfect, but when we make mistakes we fix them.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-start mb-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          All our payments are processed via PayPal. You do not need a PayPal account and we do not
                          store any payment card details on our website.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-start mb-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          There are no hidden costs, setup or termination fees attached to our SEO packages. All our
                          plans are clear. We do not charge for any additional services.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-start mb-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                          Our team do not outsource any of SEO services outside. We prefer to be in control of all
                          processes in-house and deliver the best quality in a long run.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-800 text-white p-5 rounded-lg">
                    <p className="italic text-sm mb-4">
                      &quot;We&apos;ve looked at a lot of SEO solutions but these guys were always the clear favorite.
                      They have the right strategy and they&apos;ve been awesome to work with.&quot;
                    </p>
