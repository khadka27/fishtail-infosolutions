  ...
  return (
    <>
                ...
                <div className="bg-white rounded-xl shadow-sm overflow-hidden mb-8">
                  <div className="p-6 md:p-8">
                    ...
                    <p className="text-gray-700 mb-6 leading-relaxed">
                      We collaborated with {projectData.client} to enhance their
                      lead generation efforts for their Online MBA program. Our
                      focus was to increase the volume and quality of leads
                      while optimizing the conversion rate through a
                      multi-platform digital marketing strategy.
                    </p>
                    ...
                    <div className="mb-8">
                      ...
                      <p className="text-gray-700 leading-relaxed mb-4">
                        Our comprehensive approach involved multiple digital
                            ...
                            <div>
                              ...
                              {strategy.title === "LinkedIn Ads" && (
                                <div className="mt-4 bg-blue-50 p-4 rounded-lg">
                                  <h4 className="font-medium text-blue-800 mb-2">
                                    Key LinkedIn Targeting Parameters:
                                  </h4>
                                  <ul className="space-y-1 text-sm text-gray-700">
                                    <li>
                                      • Job Titles: Managers, Directors, Team
                                      Leads
                                    </li>
                                    <li>
                              ...
                              {strategy.title === "Google Ads" && (
                                <div className="mt-4 bg-green-50 p-4 rounded-lg">
                                  ...
                                  <ul className="space-y-1 text-sm text-gray-700">
                                    <li>
                                      • Search: Targeted keywords related to MBA
                                      programs, online education
                                    </li>
                                    <li>
                                      • Display: Remarketing to website
                                      visitors, in-market audiences
                                    </li>
                                    <li>
                                      • Performance Max: Leveraging
                                      Google&apos;s AI for cross-channel
                                      optimization
                                    </li>
                                    <li>
                                      • Custom landing pages with
                    ...
                    <div>
                      ...
                      <ul className="space-y-3">
                        <li className="flex items-start">
                          ...
                          <p className="text-gray-700">
                            LinkedIn proved to be the most effective channel for
                            reaching qualified professionals interested in MBA
                            programs.
                          </p>
                        </li>
                        <li className="flex items-start">
                          ...
                          <p className="text-gray-700">
                            Continuous A/B testing and optimization led to
                            significant improvements in conversion rates over
                            time.
                          </p>
                        </li>
                        <li className="flex items-start">
                          ...
                          <p className="text-gray-700">
                            The multi-channel approach created a cohesive brand
                            experience and captured leads at different stages of
                        ...
                        <li className="flex items-start">
                          ...
                          <p className="text-gray-700">
                            CRM integration was crucial for proper lead
                            nurturing and achieving the high conversion rates.
                          </p>
                        </li>
                      </ul>
                    </div>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-lg transition-all ${
          scrolled
