                         ...
                         <div className="flex flex-col lg:flex-row items-center">
                              ...
                              >
                                   ...
                                   <p className="text-xl mb-8 text-teal-100 max-w-xl">
                                        Comprehensive analysis of your entire
                                        online presence across search, social,
                                        and review platforms to uncover
                              ...
                              >
                                   <div className="relative">
                                        ...
                                        <Image
                                             src={
                                                  footprint ||
                                                  "/digital-presence-dashboard.png"
                                             }
                    ...
                    <div className="container mx-auto px-4">
                         <div className="text-center max-w-3xl mx-auto mb-16">
                              ...
                              <p className="text-lg text-gray-600">
                                   We analyze every aspect of your online
                                   presence to provide a comprehensive view of
               ...
               <section className="py-20 px-20 bg-gray-50">
                    <div className="container mx-auto px-4">
                         <div className="text-center max-w-3xl mx-auto mb-16">
                              ...
                              <p className="text-lg text-gray-600">
                                   A methodical approach to understanding your
               ...
               <section className="py-20 px-20 bg-white">
                    <div className="container mx-auto px-4">
                         <div className="text-center max-w-3xl mx-auto mb-16">
                              ...
                              <p className="text-lg text-gray-600">
                                   Everything you need to know about our Online
                                   Presence Analysis service
                              </p>
                         </div>
                              ...
                              {[
                                   {
                                        ...
                                        answer: "Our comprehensive analysis includes an audit of your search engine visibility, social media presence, online reviews and reputation, website performance, competitor benchmarking, and analytics setup. We examine all aspects of your digital footprint to provide a complete picture of your online presence.",
                                   },
                                   {
                                        question:
                                             "How long does the analysis process take?",
                                        answer: "A complete Online Presence Analysis typically takes 7-10 business days. This allows our team to thoroughly examine all aspects of your digital presence, collect comprehensive data, and develop actionable recommendations based on our findings.",
                                   },
                                   {
                                        question:
                                             "How is this different from an SEO audit?",
                                        answer: "While an SEO audit focuses specifically on search engine optimization factors, our Online Presence Analysis takes a holistic approach to your entire digital footprint. We examine not just search visibility, but also social media presence, online reputation, website performance, and competitive positioning across all digital channels.",
                                   },
                                   {
                                        question:
                                             "Will you provide actionable recommendations?",
                                        answer: "Absolutely. Our analysis isn't just about identifying issues—it's about providing solutions. You'll receive a detailed report with prioritized, actionable recommendations for improving your online presence, along with an implementation roadmap to help you put those recommendations into practice.",
                                   },
                                   {
                                        question:
                                             "Do you offer implementation services for your recommendations?",
                                        answer: "Yes, we offer full-service implementation of all our recommendations. While you're welcome to implement the recommendations yourself or with your existing team, many clients choose to work with us for seamless execution of the strategies we develop.",
                                   },
                                   {
                                        question:
                                             "How often should I get an Online Presence Analysis?",
                                        answer: "We recommend conducting a comprehensive analysis annually, with quarterly check-ins to monitor progress and make adjustments as needed. However, if you're undergoing significant changes (rebranding, website redesign, entering new markets), an additional analysis may be beneficial.",
                                   },
                              ].map((faq, index) => (
                                   <motion.div
                                        key={index}
                    ...
                    <div className="container mx-auto px-4">
                         <div className="text-center max-w-3xl mx-auto mb-16">
                              ...
                              <p className="text-lg text-teal-100">
                                   A comprehensive analysis provides the
                                   foundation for all your digital marketing
                                   efforts
                              </p>
                         </div>
                              ...
                              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                   ...
                                   >
                                        <h2 className="text-3xl font-bold mb-6 text-gray-800">
                                             Ready to Discover Your True Digital
                                             Footprint?
                                        </h2>
                                        <p className="text-lg text-gray-600 mb-6">
                                             Get a free initial assessment of
                                             your online presence. Our team will
                                             analyze your digital footprint and
