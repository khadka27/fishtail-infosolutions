          ...
          <div className="grid grid-cols-12 grid-rows-6 h-full w-full">
            {Array.from({ length: 72 }).map((_, i) => (
              <div key={i} className="border border-white/5 flex items-center justify-center">
                {Math.random() > 0.92 && (
                  <div
                    className={`w-2 h-2 rounded-full bg-green-400 opacity-${Math.floor(Math.random() * 80) + 20}`}
                  ></div>
                )}
              </div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">Average conversion rate improvement for our clients</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">Additional revenue generated through our CRO strategies</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">Successful A/B tests conducted in the last year</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              We use data-driven strategies to identify and eliminate conversion barriers, creating frictionless paths
              to purchase
            </p>
          </div>
      ...
      <section className="py-20 px-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              A methodical approach to understanding user behavior and systematically improving conversion rates
            </p>
          </div>
              ...
              >
                ...
                <div className="w-full md:w-1/2 p-4 flex justify-center">
                  <div className="relative w-full max-w-sm">
                    ...
                    <Image
                      src={
                        step.image || `/placeholder.svg?height=300&width=400&query=data visualization for ${step.title}`
                      }
                      alt={step.title}
                      width={400}
                      height={300}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-indigo-200">
              See how our conversion rate optimization strategies have transformed businesses across industries
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Optimized landing pages with clearer value proposition and simplified signup forms",
                stats: [
              ...
              >
                <div className="h-48 overflow-hidden">
                  <Image
                    src={
                      study.image ||
                      `/placeholder.svg?height=300&width=500&query=data visualization for ${study.industry || "/placeholder.svg"} business`
                    }
                    alt={study.title}
                    width={500}
                    height={300}
                ...
                <div className="p-6">
                  <div className="text-indigo-300 text-sm font-medium mb-2">{study.industry}</div>
                  ...
                  <Link href="/project" className="inline-flex items-center text-indigo-300 hover:text-indigo-200 font-medium">
      ...
      <section className="py-20 px-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600">
              CRO delivers measurable improvements to your bottom line without increasing ad spend
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Get more customers without increasing your marketing budget",
              },
              {
                title: "Reduce Acquisition Costs",
                description: "Lower your cost per acquisition by converting more visitors",
              },
              {
                title: "Increase Customer Lifetime Value",
                description: "Optimize not just for first purchase, but for long-term customer relationships",
              },
              {
                title: "Data-Driven Decisions",
                description: "Replace guesswork with scientific testing and concrete results",
              },
              {
                title: "Improve User Experience",
                description: "Create smoother, more intuitive paths to conversion",
              },
              {
                title: "Gain Competitive Edge",
                description: "Outperform competitors by converting more of your shared audience",
              },
              {
                title: "Scalable Results",
                description: "Improvements compound over time as you implement more optimizations",
              },
              {
                title: "Higher ROI Than Acquisition",
                description: "Often delivers better returns than spending more on traffic generation",
              },
            ].map((benefit, index) => (
              <motion.div
                key={index}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl font-bold mb-6 text-gray-800">Ready to Boost Your Conversion Rates?</h2>
                <p className="text-lg text-gray-600 mb-6">
                  Get a free CRO audit and discover untapped revenue opportunities on your website. Our team will
                  analyze your current conversion funnels and identify high-impact optimization opportunities.
                </p>
                <div className="bg-indigo-100 rounded-lg p-6 mb-6">
                  <h3 className="text-xl font-bold mb-3 text-indigo-800">What You&apos;ll Get:</h3>
