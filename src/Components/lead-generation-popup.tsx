...
const LEAD_GENERATION_SERVICES = [
     { id: "email-campaigns", label: "Email Lead Generation", icon: "📧" },
     {
          ...
          label: "Content Marketing & Lead Magnets",
          icon: "📝",
     },
     ...
     {
          id: "crm-integration",
          label: "CRM Integration & Management",
          icon: "⚙️",
     },
];
...
export function LeadGenerationPopup({
          ...
          if (step === 1) {
               ...
               if (!formData.currentChallenges)
                    errors.currentChallenges =
                         "Please describe your current challenges";
     ...
     const handleSubmit = async (e: React.FormEvent) => {
          ...
          try {
               ...
               setSubmitStatus({
                    success: true,
                    message: "Thank you! Your lead generation consultation request has been submitted. Our team will contact you within 24 hours with a custom strategy proposal.",
               });
               setFormData({
                    name: "",
                    email: "",
                                   ...
                                   <div className="flex items-start">
                                        ...
                                        <div>
                                             ...
                                             <ul className="text-sm text-blue-700 space-y-1">
                                                  <li>
                                                       • Our lead generation
                                                       experts will review your
                                                       requirements
                                                  </li>
                                                  <li>
                                                       • We'll prepare a custom
                                                       strategy proposal within
                                                       24 hours
                                                  </li>
                                                  <li>
