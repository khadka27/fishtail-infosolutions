...
const reputationFeatures = [
     ...
     },
     {
          ...
          description:
               "Strategic handling of customer reviews to highlight positive feedback and address negative comments.",
          icon: Star,
          color: "yellow",
     },
     {
          ...
          description:
               "Rapid response strategies to mitigate and resolve reputation threats and PR crises.",
          icon: AlertCircle,
          color: "red",
     },
     {
          ...
          description:
               "Legal and technical approaches to remove harmful or inaccurate content about your brand.",
          icon: Trash2,
          color: "purple",
     },
     {
          ...
          description:
               "Strategic SEO to promote positive content and suppress negative search results.",
          icon: Search,
          color: "green",
     },
     {
          ...
          description:
               "Detailed analytics and insights on your brand's reputation across digital channels.",
          icon: BarChart,
          color: "teal",
     },
];
...
const reputationSteps = [
     {
          ...
          description:
               "We analyze your current online reputation and identify strengths, weaknesses, and potential threats.",
          icon: Search,
     },
     {
          title: "Strategy Development",
          description:
               "Our experts create a customized reputation management strategy tailored to your specific needs.",
          icon: FileText,
     },
     {
          title: "Content Creation",
          description:
               "We develop high-quality content that showcases your brand's strengths and expertise.",
          icon: Briefcase,
     },
     {
          title: "Implementation",
          description:
               "Strategic execution of reputation management tactics across relevant platforms and channels.",
          icon: Globe,
     },
     {
          title: "Monitoring & Response",
          description:
               "Continuous monitoring of your online presence with rapid response to emerging issues.",
          icon: Eye,
     },
     {
          title: "Reporting & Optimization",
          description:
               "Regular reporting on progress with data-driven adjustments to maximize results.",
          icon: BarChart,
     },
];
...
const caseStudies = [
     {
          ...
          description:
               "Transformed a restaurant chain's reputation after a viral negative incident, increasing ratings by 2.8 stars.",
          image: image1,
          bgColor: "bg-[#1ab5b3]",
     ...
     },
     {
          ...
          description:
               "Rebuilt a C-suite executive's digital presence after misleading information damaged their professional image.",
          image: image2,
          bgColor: "bg-[#2c3e50]",
     ...
     },
     {
          ...
          description:
               "Protected a healthcare provider from coordinated negative review campaigns with strategic response management.",
          image: image4,
          bgColor: "bg-[#8bc34a]",
     ...
     },
     {
          ...
          description:
               "Restored consumer trust for an e-commerce brand after product quality concerns emerged on social media.",
          image: image1,
          bgColor: "bg-[#e74c3c]",
     ...
     },
     {
          ...
          description:
               "Transformed a hotel chain's digital reputation through strategic review management and content creation.",
          image: image2,
          bgColor: "bg-[#9b59b6]",
     ...
     return (
          <div className="flex flex-col" ref={sectionRef}>
               ...
               >
                    <div className="max-w-4xl mx-auto">
                         ...
                         >
                              <div className="relative w-64 h-64">
                                   <Image
                                        src={
                                             image1 ||
                                             "/placeholder.svg?height=256&width=256&query=reputation management shield"
                                        }
                         ...
                         >
                              ...
                              your online reputation with strategic monitoring,
               ...
               >
                    ...
                    >
                         ...
                         <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                              We offer a complete suite of reputation management
                              services to protect, repair, and enhance your
                              brand&apos;s online presence across all digital
                              channels.
                         </p>
                    </motion.div>
               ...
               >
                    <div className="max-w-6xl mx-auto">
                         ...
                         >
                              ...
                              <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                                   We follow a structured, data-driven approach
                                   to managing and improving your online
                                   reputation through strategic monitoring,
                                   content creation, and proactive response.
                              </p>
                         </motion.div>
               ...
               >
                    ...
                    >
                         <h2 className="text-3xl font-light text-gray-700 mb-4">
                              Our Reputation Management Impact
                         </h2>
                         <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                              We&apos;ve helped hundreds of businesses and
                              individuals repair, protect, and enhance their
                              online reputations. Here&apos;s our track record
                              of success.
                         </p>
                    </motion.div>
                    ...
                    >
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#3a5998] mb-2">
                                   500+
                              </div>
                         ...
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#1abc9c] mb-2">
                                   85%
                              </div>
                              <div className="text-sm text-gray-600">
                                   Rating Improvement
                         ...
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#2ecc71] mb-2">
                                   10K+
                              </div>
                              <div className="text-sm text-gray-600">
                                   Reviews Managed
                         ...
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#f1c40f] mb-2">
                                   48
                              </div>
                              <div className="text-sm text-gray-600">
                                   Hours Response
                         ...
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#e67e22] mb-2">
                                   20+
                              </div>
                              <div className="text-sm text-gray-600">
                                   Industries Served
                         ...
                         <motion.div
                              ...
                              whileHover={{ y: -5 }}
                         >
                              <div className="text-4xl font-light text-[#e84393] mb-2">
                                   97%
                              </div>
                              <div className="text-sm text-gray-600">
                                   Client Satisfaction
               ...
               >
                    <div className="max-w-6xl mx-auto">
                         ...
                         >
                              ...
                              <Link
                                   href="/case-studies"
                                   className="text-[#3a5998] text-sm hover:underline flex items-center"
                              >
                              ...
                              >
                                   {[0, 1, 2].map((i) => {
                                        ...
                                        return (
                                             ...
                                             >
                                                  <div
                                                       className={`h-48 ${caseStudy.bgColor} flex items-center justify-center relative`}
                                                  >
                                                       <Image
                                                            src={
                                                                 caseStudy.image ||
                              ...
                              <div className="flex justify-center gap-2 mb-8">
                                   {caseStudies.map((_, index) => (
                                        <button
                                             ...
                                             aria-label={`Go to case study set ${
               ...
               >
                    ...
                    >
                         <h2 className="text-3xl font-light text-gray-700 mb-4">
                              Platforms We Monitor & Manage
                         </h2>
                         <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
                              We actively monitor and manage your reputation
                              across all major digital platforms where your
                              brand may be mentioned, reviewed, or discussed.
                         </p>
                    </motion.div>
                    ...
                    >
                         <div className="text-center mb-8">
                              ...
                              <p className="text-gray-600 max-w-2xl mx-auto">
                                   ...
                                   and receive actionable recommendations to
