...
const mobileFeatures = [
  {
    ...
    description: "Custom mobile applications for iOS and Android that engage users and drive business growth.",
    icon: Smartphone,
    color: "blue",
  },
  {
    title: "SMS Marketing",
    description: "Direct and effective text message campaigns with high open rates and engagement.",
    icon: MessageCircle,
    color: "red",
  },
  {
    title: "Mobile Social Media",
    description: "Targeted social media strategies optimized for mobile users and platforms.",
    icon: Share2,
    color: "green",
  },
  {
    title: "Mobile Analytics",
    description: "Comprehensive tracking and analysis of mobile user behavior and campaign performance.",
    icon: BarChart2,
    color: "purple",
  },
  {
    title: "Push Notifications",
    description: "Timely, personalized alerts that drive engagement and bring users back to your app.",
    icon: Bell,
    color: "orange",
  },
  {
    title: "Location-Based Marketing",
    description: "Geo-targeted campaigns that reach users based on their physical location.",
    icon: Target,
    color: "teal",
  },
]
...
const marketingSteps = [
  {
    ...
    description: "We analyze your target audience, competitors, and mobile market opportunities.",
    icon: Compass,
  },
  {
    title: "App Design & Development",
    description: "Our designers and developers create intuitive, engaging mobile experiences.",
    icon: Smartphone,
  },
  {
    title: "Campaign Creation",
    description: "We develop targeted mobile marketing campaigns aligned with your business goals.",
    icon: Target,
  },
  {
    title: "Testing & Optimization",
    description: "Rigorous testing ensures your app and campaigns perform optimally across all devices.",
    icon: Layers,
  },
  {
    title: "Launch & Promotion",
    description: "We deploy your app and campaigns with strategic promotion to maximize visibility.",
    icon: Zap,
  },
  {
    title: "Analysis & Refinement",
    description: "Ongoing monitoring and optimization to improve performance and ROI.",
    icon: BarChart2,
  },
]
...
const projects = [
  {
    ...
    description: "Mobile app with personalized workout plans and progress tracking features.",
    image: image2,
    bgColor: "bg-[#1ab5b3]",
  ...
  },
  {
    ...
    description: "Mobile loyalty program with location-based offers and personalized rewards.",
    image: image3,
    bgColor: "bg-[#2c3e50]",
  ...
  },
  {
    ...
    description: "Mobile ordering system with push notifications and loyalty rewards.",
    image: image4,
    bgColor: "bg-[#8bc34a]",
  ...
  },
  {
    ...
    description: "Location-based travel guide with personalized recommendations and offline maps.",
    image: image1,
    bgColor: "bg-[#e74c3c]",
  ...
  },
  {
    ...
    description: "Mobile ticketing system with QR codes, push notifications, and social sharing.",
    image: image2,
    bgColor: "bg-[#9b59b6]",
    ...
    <div className="flex flex-col" ref={sectionRef}>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            Reach your customers where they spend the most time - on their mobile devices. Our{" "}
            <span className="font-bold">mobile-first strategies</span> drive engagement, conversions, and{" "}
          ...
          >
            ...
            >
              <span className="font-medium">Start Your Campaign</span>
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-light text-gray-700 mb-4">Comprehensive Mobile Marketing Solutions</h2>
          <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
            From app development to SMS campaigns and location-based marketing, we offer end-to-end mobile solutions to
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="text-4xl font-light text-[#8e44ad] mb-2">70%</div>
              <div className="text-sm text-gray-600">of digital media time is spent on mobile</div>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="text-4xl font-light text-[#8e44ad] mb-2">98%</div>
              <div className="text-sm text-gray-600">SMS open rate compared to 20% for email</div>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="text-4xl font-light text-[#8e44ad] mb-2">90%</div>
              <div className="text-sm text-gray-600">of mobile users act within an hour</div>
            </motion.div>
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
            >
              <div className="text-4xl font-light text-[#8e44ad] mb-2">127%</div>
              <div className="text-sm text-gray-600">higher conversion rates on mobile-optimized sites</div>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-light text-gray-700 mb-4">Our Mobile Marketing Process</h2>
          <p className="text-gray-600 leading-relaxed max-w-3xl mx-auto">
            We follow a structured approach to create mobile marketing strategies that deliver measurable results.
          </p>
        </motion.div>
            ...
            {marketingSteps.map((step, index) => (
              ...
              >
                <div className={`w-full md:w-1/2 ${index % 2 === 0 ? "md:text-left" : "md:text-right"}`}>
                  <motion.div
                    className={`bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer ${
                      activeStep === index ? "ring-2 ring-[#8e44ad]" : ""
                    }`}
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl font-light text-gray-700">Our mobile marketing projects</h2>
            <Link href="/projects" className="text-[#8e44ad] text-sm hover:underline flex items-center">
              ...
              {projects.map((_, index) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all duration-300 ${
                    Math.floor(currentProjectIndex / 3) === Math.floor(index / 3) ? "w-6 bg-[#8e44ad]" : "bg-gray-300"
                  }`}
