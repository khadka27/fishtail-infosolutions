...
const PHONE_PATTERNS: Record<string, RegExp> = {
  ...
  "+49": /^\+49[1-9]\d{10,11}$/, // Germany
  "+39": /^\+39\d{6,11}$/, // Italy
  "+34": /^\+34[6-9]\d{8}$/, // Spain
  "+31": /^\+31[1-9]\d{8}$/, // Netherlands
  "+91": /^\+91[6-9]\d{9}$/, // India
  "+86": /^\+86[1]\d{10}$/, // China
  "+81": /^\+81[7-9]\d{8}$/, // Japan
  "+82": /^\+82[1]\d{7,8}$/, // South Korea
  "+61": /^\+61[2-478]\d{8}$/, // Australia
  "+55": /^\+55[1-9]{2}9?\d{8}$/, // Brazil
  "+52": /^\+52[1-9]\d{9}$/, // Mexico
  "+7": /^\+7[3-9]\d{9}$/, // Russia/Kazakhstan
  ...
  <div className="flex items-center justify-center mb-6">
    {[1, 2, 3].map((step) => (
      <div key={step} className="flex items-center">
        ...
        {step < 3 && <div className={`w-12 h-1 ${step < currentStep ? "bg-[#0084FF]" : "bg-gray-200"}`} />}
      </div>
    ))}
  </div>
)
...
const renderFormStep = () => {
  switch (currentStep) {
    case 1:
      return (
        <>
          <h3 className="text-xl font-medium text-gray-800 mb-4">Website Information</h3>
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-[#0084FF] transition-all duration-200 ${
                formErrors.websiteUrl ? "border-red-500 bg-red-50" : "border-gray-300"
              }`}
              ...
              <div className="flex">
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center px-3 py-3 border rounded-l-md bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-[#0084FF] transition-all duration-200 ${
                      formErrors.phone ? "border-red-500" : "border-gray-300"
                    }`}
                  >
                    <span className="mr-1">{COUNTRY_CODES.find((c) => c.code === formData.countryCode)?.flag}</span>
                    ...
                    <div className="absolute top-full left-0 z-50 w-80 bg-white border border-gray-300 rounded-md shadow-lg max-h-60 overflow-hidden">
                      <div className="p-2 border-b">
                        <input
                          ...
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#0084FF]"
                        />
                      </div>
    ...
    case 3:
      return (
        <>
          <h3 className="text-xl font-medium text-gray-800 mb-4">Confirm Your Information</h3>
          ...
          <div className="bg-blue-50 border-l-4 border-[#0084FF] p-4 mb-6">
            <p className="text-sm text-gray-700">
              By submitting this form, you&apos;ll receive a comprehensive SEO analysis of your website within 2-3
              business days. Our team will identify opportunities to improve your search rankings and visibility.
            </p>
          </div>
        </>
      )
