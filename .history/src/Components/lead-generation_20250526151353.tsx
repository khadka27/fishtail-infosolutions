...
// Calendly Hook for better state management
const useCalendly = () => {
      ...
      script.onload = () => {
        ...
        setTimeout(() => {
          if (window.Calendly) {
            ...
            setError("Calendly object not available")
  ...
  const openPopup = useCallback(
    async (url: string) => {
      try {
        ...
        setError("Unable to open calendar. Opening in new tab...")
...
// Quick booking component for immediate scheduling
...
export default function LeadGeneration() {
  ...
  useEffect(() => {
    const testUrl = async () => {
      try {
        // This is just to check if the URL format is correct
