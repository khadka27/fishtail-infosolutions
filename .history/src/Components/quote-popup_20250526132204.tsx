        ...
        return (
          <>
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              {formData.details && (
                <div className="mt-4">
                  <p className="text-sm text-gray-500">SEO Goals</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• Our SEO experts will analyze your website within 2-3 business days</li>
                    <li>• You'll receive a comprehensive report with actionable recommendations</li>
                    <li>• We'll identify opportunities to improve your search rankings and traffic</li>
                    <li>• No obligation - this analysis is completely free</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            >
              <div className="bg-[#0084FF] py-6 px-6 sm:px-8 relative text-white">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                  <div className="flex-1">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-2">FREE Website SEO Analysis</h2>
                    <p className="text-sm sm:text-base text-white/90">
                      Our team will review your website&apos;s SEO performance and provide actionable recommendations to
                      boost your rankings and traffic.
                    </p>
                  </div>
                  <div className="flex-shrink-0 hidden sm:block">
                    <div className="bg-white/20 p-3 rounded-full">
                      <Image
                        src={Seoptimize || "/placeholder.svg?height=80&width=80&query=SEO analysis illustration"}
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="quote-form-email">
                  ...
                  <input type="hidden" name="websiteUrl" value={formData.websiteUrl} />
