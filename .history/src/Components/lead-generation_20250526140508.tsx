      ...
      const timer = setTimeout(() => {
        if (window.Calendly) {
          window.Calendly.initPopupWidget({
            url: "https://calendly.com/diwasgrg-fishtailinfosolutions/30min", // Replace with your actual Calendly URL
  ...
  const openCalendlyPopup = () => {
    if (window.Calendly) {
      ...
      script.onload = () => {
        if (window.Calendly) {
          window.Calendly.initPopupWidget({
            url: "https://calendly.com/diwasgrg-fishtailinfosolutions/30min", 
            text: "Schedule time with me",
            color: "#2563eb",
            textColor: "#ffffff",
            branding: true,
